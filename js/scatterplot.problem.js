                                 ...
                                 margin = 50)
{
    ...
    legends_items.on("click", function(event, d) {

        const item = d3.select(this);
        item.classed("legendSelect", !item.classed("legendSelect"));
        const activeCats = new Set(
            legends_items.filter(".legendSelect").data()
        ...
        circles
            .attr("opacity", c => activeCats.has(c[colorCol]) ? 1 : 0.05)
    });
